...
<section id="hero">
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <!-- Slide 1 -->
            <div class="carousel-item active" style="background-image: url(assets/img/slide/smk1-triple-j-guru.png)">
                <div class="carousel-container">
                    <div class="container">
                        <h3 class="animate__animated animate__fadeInDown">Sistem Pendukung Keputusan Perangkingan Beasiswa Smk 1 TRIPLE J</h3>
...
<main id="main">
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row content">
                <div class="col-lg-6">
                    <p>
                        Mendidik dan membina siswa menjadi tenaga teknologi informasi yang profesional, berjiwa kewirausahaan, dan berperilaku Islami serta mampu menghadapi tantangan dunia kerja yang meliputi kegiatan sebagai berikut:
                    </p>
                    <ul>
    ...
    <section id="counts" class="counts">
        <div class="container" data-aos="fade-up">
            ...
            <!-- SnapWidget -->
            <script src="get.jshttps://snapwidget.com/js/snapwid"></script>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="info-box">
                                <i class="bx bx-map"></i>
                                <h3>Alamat</h3>
                                <p>Jln. Lanbau Karang Asem Barat Kec.Citeureup Kab. Bogor</p>
                            </div>
                        </div>
                        <div class="col-md-6">
